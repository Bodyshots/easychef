# Generated by Django 4.1.7 on 2024-10-18 17:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star_rating', models.DecimalField(decimal_places=2, default=0, max_digits=3, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)])),
                ...
                ('diets', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('VE', 'Vegan'), ('HA', 'Halal')], max_length=5)),
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='myrecipes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='RecipeComment',
